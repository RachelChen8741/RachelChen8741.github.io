        ...
        <section id="about" className="px-5 py-20 md:px-10 bg-blossom bg-cover bg-opacity-50 ">
            <div className="container mx-auto flex flex-col md:flex-row items-center">
                <div className="md:flex-grow md:w-1/2 sm:w-full lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center max-h-screen sm:max-h-full">
                    <h1 className="title-font text-6xl mb-4 font-medium text-black">
                        Hi, I'm Rachel!
                        <br />
                    </h1>
                    ...
                    <div className="leading-relaxed h-48 overflow-hidden mb-4  sm:mb-1 text-3xl text-gray-500">
                        <TypewriterComponent
                            options={{
                    ...
                    <div className="flex justify-center">
                        ...
                        <a
                            ...
                            <ArrowUpOnSquareIcon className="mx-auto inline-block w-7 mr-1"></ArrowUpOnSquareIcon> Résumé 
                        </a>
                    </div>
                </div>
